...
- **動物圖標**（預設關）：即時顯示附近動物——野生／畜養獨立開關、9 物種篩選
  （牛/羊/豬/鹿/雞/火雞/兔/浣熊/鼠類）；地圖符號或彩色物品圖兩種風格，大小、
  顏色可調（色盲友善 8 色）；全部使用遊戲內建素材。MP 下他人安全屋內的牲畜
  預設隱藏（沙盒可開放）
...
- **世界地圖圖標**（預設關）：殭屍點位／野生動物／畜養動物／載具四個獨立開關，
  ...
  新增爪印按鈕直開設定視窗
- **統一設定視窗**（齒輪鈕）：雙欄六區塊（圖層顯示／殭屍點位／動物圖標／載具圖標／
  世界地圖圖標／外觀與行為）可收合、全部展開／收合、收合時標題列顯示現況摘要；各語系實測字寬
  自適應版面、內容捲動不超出螢幕；引擎原生「等軸測／符號／遠端符號」整併於此，
  勾選即存、與 ESC 選項頁雙向同步
- **按鈕列**：M（世界地圖）、-／+（縮放）、C（回到玩家）、齒輪（統一設定視窗）、
  X（關閉）；按鈕動態間距，最小尺寸也裝得下
...
| 殭屍點顏色／大小／上限 | 橘／中／200 | 五色、三檔大小、上限 100～800 隻（可視範圍內，超過上限優先顯示離自己較近者），存檔即生效 |
| 顯示野生／畜養動物圖標 | 關／關 | 即時顯示附近動物（0.5 秒取樣、可視範圍內）；統一視窗可再按 9 物種篩選。MP 下他人安全屋內的牲畜預設隱藏（沙盒可開放） |
| 動物圖標風格／動物/載具圖標大小 | 地圖符號／中 | 風格：原版地圖符號（可染色）或彩色物品圖；大小三檔（彩圖檔位自動較大，細節較多） |
...
| 顯示其他玩家的牲畜 | 關 | 開啟＝可看到自己不屬於的安全屋內的牲畜；預設關保護基地隱私（安全屋範圍外的散養一律可見） |
