#!/usr/bin/env python3
"""產生 MOD/MinidoracatMiniMapFor42/workshop.txt（Workshop 上傳工具輸入）。
...
OUT = os.path.join(ROOT, "MOD", "MinidoracatMiniMapFor42", "workshop.txt")

# Workshop metadata（來源真相在此；workshop.txt 已不入版控）
META_HEAD = [
    "version=1",
    "id=3763913359",
    "title=Minidoracat MiniMap for B42",
]
META_TAIL = [
