...
[*] [b]地圖搜尋[/b]：放大鏡鈕或右鍵「搜尋地圖…」——座標、街道名（[u]中英文都可搜[/u]）、設施類別（藥局、槍店等 20 類），依距離排序；可跳大地圖（金色脈動標記）或直接設為導航目標。可確認來源的 MOD 街道會標「MOD 地圖：地圖名稱」，只說明這條街來自哪張地圖，不代表有錯
...
[h2]🧩 地圖 MOD 支援[/h2]
搭配 [url=https://steamcommunity.com/sharedfiles/filedetails/?id=3763914102]MOD Maps 地圖包[/url]：多張地圖 MOD 的小地圖圖像＋範圍框線，自動偵測、對應 MOD 啟用才顯示。本體 42.20.4-0.27.0 起請搭配地圖包 42.20.4-0.9.0 或更新版本，兩包一起更新並重啟遊戲。
